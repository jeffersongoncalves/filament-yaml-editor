...
### ViewYamlAction (Table Action)

Modal action to view YAML content from a record. **In Filament v3, this extends `Filament\Tables\Actions\Action`** — use it only in table action contexts.
