...
A YAML editor field for Filament v4 powered by CodeMirror 6 with syntax highlighting, linting, toolbar, and auto-formatting.
...
- **ViewYamlAction** — Action to view YAML content in a modal.
